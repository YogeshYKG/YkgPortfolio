...
const Project_Works = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row p-4 gap-6 max-w-screen-xl mx-auto">
      ...
      <div className="relative w-full aspect-video rounded-lg overflow-hidden border shadow-lg mb-6">
        ...
        >
          ...
          {/* Panel Content */}
          {expanded && (
            <div className="p-4 overflow-y-auto h-[calc(100%-40px)] text-sm">
      ...
      <div className="w-full lg:w-80 max-h-[500px] overflow-y-auto space-y-4">
        {projectData.map((project) => (
          <div
            ...
            onClick={() => {
              ...
              setExpanded(true); // collapse if switching project
            }}
          >
            <img
